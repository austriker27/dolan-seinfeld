...
<a class="flex items-center justify-center w-12 h-12 p-3 border-2 border-transparent rounded-full cursor-pointer bg-background-secondary align-center hover:border-ternary" @click.prevent="toggleTheme">
    <!-- SUN SVG -->
    <svg v-if="theme === 'theme-light'" class="w-6 h-6 text-yellow-300 fill-current" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
        <path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z">
        </path>
    </svg>
    <!-- MOON SVG -->
    <svg v-else class="w-6 h-6 fill-current text-copy-ternary " stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
